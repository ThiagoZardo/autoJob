...
### AJ-E00-008 — Criar templates de issue e pull request

- **Epic:** E0
- **Objetivo:** padronizar contexto, objetivo, escopo, fora de escopo, aceite, verificação, dependências e notas de segurança/custo.
- **Dependências:** AJ-E00-001.
- **Critérios de aceite:** templates refletem o contrato de task; tamanhos e campos do GitHub Projects são documentados.
- **Tamanho:** XS
- **Origem:** T005.
...
### AJ-E01-012 — Configurar observabilidade base e alarmes

- **Epic:** E1
- **Objetivo:** padronizar logs JSON/correlation ID e declarar alarmes de erro, throttling e DLQ.
- **Dependências:** AJ-E01-007, AJ-E01-008, AJ-E01-011.
- **Critérios de aceite:** logs redigem campos sensíveis; alarmes possuem threshold/destino documentados; testes de IaC passam.
- **Tamanho:** S
- **Origem:** parte de T011.

### AJ-E01-013 — Configurar AWS Budget e kill switch

- **Epic:** E1
- **Objetivo:** declarar alertas de orçamento e mecanismo que desabilite schedules sem apagar estado.
- **Dependências:** AJ-E01-010, AJ-E01-012.
- **Critérios de aceite:** thresholds são configuráveis; kill switch é reversível; evidência mostra filas/estado preservados.
- **Tamanho:** S
...
### AJ-E05-007 — Adicionar cache e telemetria de token/custo

- **Epic:** E5
- **Objetivo:** evitar reavaliação por fingerprint+versão e registrar uso/custo estimado.
- **Dependências:** AJ-E03-003, AJ-E05-005.
- **Critérios de aceite:** cache invalida com mudança relevante; hit não chama modelo; métricas por vaga não incluem prompts/PII.
- **Tamanho:** S
- **Origem:** T024 e parte da estratégia de T022.
...
- **Dependências:** AJ-E05-007, AJ-E07-006, AJ-E08-005.
...
- **Dependências:** AJ-E05-007, AJ-E09-001.
...
### AJ-E09-005 — Criar runbooks operacionais

- **Epic:** E9
- **Objetivo:** documentar pause/resume, kill switch, rotação de segredos, recuperação de DLQ, reconciliação e rollback.
- **Dependências:** AJ-E01-013, AJ-E07-006, AJ-E09-004.
- **Critérios de aceite:** passos têm pré-condições/verificação; procedimentos não expõem segredos; rollback preserva estado.
- **Tamanho:** S
- **Origem:** parte de T037 e critérios de release.

### AJ-E09-006 — Executar teste operacional de sete dias

- **Epic:** E9
- **Objetivo:** verificar o vertical slice em dev por sete dias sem intervenção rotineira, exceto eventos externos previstos.
- **Dependências:** AJ-E09-005; gates do Milestone 1 concluídos.
- **Critérios de aceite:** período, incidentes, custos e intervenções são registrados; critérios do MVP são avaliados; falhas viram novas tasks, não correções fora de escopo.
...
- **Dependências:** AJ-E09-006, AJ-E10-001.
...
### AJ-E11-002 — Implementar worker efêmero e isolado

- **Epic:** E11
- **Objetivo:** criar runtime sob demanda com menor privilégio, timeout, redaction e encerramento garantido.
- **Dependências:** AJ-E11-001, AJ-E01-013.
- **Critérios de aceite:** worker nasce desligado; termina após job/timeout; secrets não aparecem em logs/imagem; custo máximo é limitado.
- **Tamanho:** S
- **Origem:** Epic 11.

### AJ-E11-003 — Integrar um fluxo browser suportado

- **Epic:** E11
- **Objetivo:** conectar um único adaptador compatível ao worker com idempotência e detecção de bloqueio.
- **Dependências:** AJ-E11-002, AJ-E07-006.
